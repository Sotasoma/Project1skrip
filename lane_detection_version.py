...
parser.add_argument('--model_cfg', type = str, default ='yolov4-tiny-custom2.cfg',
                    help = 'Path to config file')
parser.add_argument('--model_weights', type=str,
                    default='yolov4-tiny-custom_best2.weights',
...
classes = []
with open("D:\skripsi\y-20230516T102303Z-001\y\obj.names", "r") as f:
