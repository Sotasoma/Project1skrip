...
parser.add_argument('--model_cfg', type = str, default ='yolov4-tiny.cfg',
                    help = 'Path to config file')
parser.add_argument('--model_weights', type=str,
                    default='yolov4-tiny.weights',
                    help='path to weights of model')
parser.add_argument('--video', type=str, default='dash.mp4',
                    help='path to video file')
parser.add_argument('--src', type=int, default=0,
                    help='source of the camera')
parser.add_argument('--output_dir', type=str, default='D:/INKA/Lane-Detection/',
...
###TASK 
# ganti cap ke module rs
# sesuikan tipedatanya
...
if cameraFeed:
    ...
    cap = np.asanyarray(ir_left.get_data())
    # set frame wieght belum
else:
    cap = cv2.VideoCapture(args.video)
    output_file = args.video[:-4].rsplit('/')[-1] + '_Detection.avi'
count=0
